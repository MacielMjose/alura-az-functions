...
def copy_azure_files():
    ...
    env_storage = "DefaultEndpointsProtocol=https;AccountName=storageblobtimetrigger;AccountKey=csUaUOQreQwXJMYlfBW0v39zMhcd8EFnkwjMd1RZGy5FxTssiD7iDqoGq9CGymdkzyTlr/UN8Bng+AStDQY4vg==;EndpointSuffix=core.windows.net"
